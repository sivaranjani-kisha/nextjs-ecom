...
// export default function ProductPage(currentProductId, categoryId) {
...
// Function to fetch category products
// // ✅ FIXED (only track product.category and product._id)
// useEffect(() => {
...
//   `/api/product/category/${categoryId}?limit=3&exclude=${product._id}`
// );
