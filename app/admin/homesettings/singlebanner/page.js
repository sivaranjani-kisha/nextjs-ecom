...
export default function SingleBannerPage() {
  const [banners, setBanners] = useState([]); // keep array to reuse your map UI
  ...
  // Fetch single banner but adapt as array of 1
const fetchBanners = async () => {
  ...
  // Handle input changes for the one banner
...
>
  + Add New Banner
            ...
            <div className="border p-4 rounded-lg space-y-3">
              <h3 className="font-medium text-lg">Add / Replace Banner</h3>
