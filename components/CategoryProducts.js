          ...
          <div className="space-y-6 max-w-7xl mx-auto">
            ...
            {categoryProducts
              ...
              .map((categoryProduct) => {
                ...
                // Determine the final URL, fallback to default
                const finalBgUrl =
                  sanitizedCategoryImage ||
                  sanitizedBackgroundImage ||
                  "/default-image.jpg";

                // Ensure the URL is valid for CSS
                  ...
                  <div key={categoryProduct._id} className="space-y-4">
                    ...
                    <div className={`bg-white flex flex-col md:flex-row mb-8 ${alignment === "right" ? "md:flex-row-reverse" : ""}`} >
                      ...
                      <div className="flex-shrink-0 relative w-full md:w-[350px] h-48 sm:h-64 md:h-auto">
                        ...
                        <div 
                         style={styleObj}
                        className={`absolute inset-0 bg-cover bg-center    ${alignment === "right" 
                   ...
                   <div className="w-full md:w-[calc(100%-350px)]">
                      <div
                        className={`relative flex-1 py-2 border overflow-hidden ${
