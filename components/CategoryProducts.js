          ...
          <div className="space-y-6 max-w-7xl mx-auto">
            ...
            {categoryProducts
              .map((categoryProduct) => {
                ...
                const categoryStyle             = categoryStyles[category.category_slug] || { backgroundImage: '/uploads/small-appliance-banner.webp', borderColor: '#1F3A8C' };
                  ...
                  <div key={categoryProduct._id} className="space-y-4">
                      ...
                      <div className="flex-shrink-0 relative w-full md:w-[350px] h-48 sm:h-64 md:h-auto">
                        ...
                        <div className="relative z-10 h-full flex flex-col justify-end p-4 sm:p-6 text-white">
                          ...
                          <Link href={categoryProduct.categoryRedirectUrl || `/category/${category.category_slug}`}
                            ...
                            onClick={() => setNavigating(true)} >  Shop Now → </Link>
                        </div>
                      </div>
                    ...
                    <div className="w-full md:w-[calc(100%-350px)]">
                      <div className={`relative flex-1 py-2 border overflow-hidden ${ alignment === "right" ? "pr-3 pl-2" : "pl-3 pr-2"}`}
                        style={{ borderTop: `4px solid ${categoryProduct.borderColor || categoryStyle.borderColor}`,
                        ...
                        <div
                          ...
                          <div
                          key={product._id}
                          className="relative bg-white flex-none flex flex-col justify-between p-2 rounded-lg border border-gray-200 hover:border-[#0069c1] hover:shadow-md transition cursor-pointer"
                          style={{
                            width: "23.5%",     // mobile default
                            minWidth: "23.5%",  // ensure flex-none works
                          }}
                        >
                        {/* Image */}
