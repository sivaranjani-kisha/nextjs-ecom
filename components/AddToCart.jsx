...
if (selectedFrequentProducts?.length > 0) {
  ...
  className={`w-full sm:w-auto px-2 py-2 md:px-3 md:py-2 border border-1 rounded-md  transition duration-300 text-sm flex items-center justify-center gap-x-1 
    ${isOutOfStock
